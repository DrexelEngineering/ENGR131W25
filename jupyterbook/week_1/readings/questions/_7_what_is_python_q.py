...
class Question1(MCQuestion):
    def __init__(self):
        super().__init__(
            title="What is a key difference between high-level and low-level programming languages?",
            style=MCQ,
            question_number=1,
            keys=[
                "q1-High-Level-v-Low-Level",
                "q2-Python-Advantages",
                "q3-Python-Interpreter",
            ],
            options=[
                [
